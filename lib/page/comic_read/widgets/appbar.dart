    ...
    return AnimatedPositioned(
      ...
      child: ClipRect(
        child: BackdropFilter(
          ...
          child: AppBar(
            title: Text(title),
            backgroundColor: setting.backgroundColor.withValues(alpha: 0.5),
...
class _SettingsDialogState extends State<SettingsDialog> {
  ...
  void initState() {
    super.initState();
    _selectedMode = _getReadModeLabel(setting.readMode);
  }
    ...
    return ListTile(
      ...
      onTap: () {
        ...
        if (value == 'topToBottom') {
          setting.setReadMode(0);
        } else if (value == 'leftToRight') {
          setting.setReadMode(1);
        } else if (value == 'rightToLeft') {
          setting.setReadMode(2);
        }
